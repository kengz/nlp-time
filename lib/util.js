...
var ordering = ['y', 'M', 'd', 'h', 'm', 's']
var factor = [365, 30, 24, 60, 60]
...
function splitT(str) {
  ...
  // !do carry to the result here. Lol it's already missing w
  return [_y, _M, _d, _h, _m, _s]
}

splitT('t:10.5M05d14h48m00.010s,dt:')

// step0: down-carry weeks and dump it
...
function carryDown(TO, orderArr) {
  var carry = 0;
  // !dont carry the last one
...
function lowestOverride(t) {
  ...
  for (var i = timeUnitOrder.length - 1; i >= 0; i--) {
