...
// !fix meridiem, merge too
  ...
  var stringified = symsToNorm(syms)
  console.log('p#9', stringified);
  return stringified
}

// recombine into norm string
// if token was normal form, has ISO normal forms, parse into ISO n return, or is parseable ISO-complete
