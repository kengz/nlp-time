...
function nTOp(nL, op, TR) {
  console.log("exec nTOp", nL, op, TR)
  // set the default op
  op = op || symbol('times')
...
var str = "quarter four hour and half from 7 and half pm"
...
// exp
// syms.push(symbol('plus'))
// syms.push(symbol('half'))
// console.log('modify syms', syms)
