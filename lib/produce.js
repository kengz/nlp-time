...
norm('tonight')
  // norm(str)
  // norm('tonight 3 hours after 9pm')
  // yeah the mod n shits failing here, but let Matt take over for now
  // norm('tonight at 3 hours after 9pm')
  // norm('today at 3 hours after 9am')
  // norm('2 days after tomorrow')
...
// !fix the prepended 0 with decimal too
