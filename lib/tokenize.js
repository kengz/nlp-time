...
function parseSubnormal(str) {
  ...
  if (m = re.MMsDDdMMsDD.exec(str)) {
    ...
    var unit = _.includes(['t', 'dt', 'T'], sym.constructor.name) ? (m[3] || '') : '';
...
/**
 * Run parseNormal then parseSubnormal, return the parsed string with T-format tokens.
 * @param  {string} str The input string
...
var str = "05 October 2011 14:48 UTC 08/11 2020 2012/12 event is at tonight 12/20- 23 12/22 - 12/23 12/22 - 12/25 05:30h 17:30 1730 1730pm 5pm"
