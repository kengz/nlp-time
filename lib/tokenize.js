    ...
    try {
      ...
      while (1) {
        if (new Date(head.replace(/^\s*\S+\s*/, '')).toISOString() != normalDate) {
          // front token eaten causes value to change, dont update head
          break;
        } else {
          // update head
...
// still need to get the chunk of string that was used in parsing
// also, need to parse as many times as needed

// var str = "event is at Wed, 05:30pm Aug 9 1995 bla bla bla "
// console.log(typeof new Date("Wed, 05:20pm Aug 9 1995"))
var str = "event is at 08/11 2020 at 10/23 2010 at 12/13 2019"
console.log("str", str)
  // console.log(new Date(str).toISOString())
var d1 = parseNormal(str)
  // var d2 = parseNormal(str)
console.log(d1)
...
var str = " 12/31 event is at 05 October 2011 14:48 UTC tonight 12/20- 23 12/22 - 12/23 12/22 - 12/25 05:30h 17:30 1730 "
